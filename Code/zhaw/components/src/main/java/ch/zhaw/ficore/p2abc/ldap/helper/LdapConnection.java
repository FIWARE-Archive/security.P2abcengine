...
public class LdapConnection {
    ...
    private static final XLogger LOGGER
        = new XLogger(LoggerFactory.getLogger(LdapConnection.class));
     ...
     *             on an LDAP error
     */
    public LdapConnection(final ConnectionParameters config)
            throws NamingException {
        if (config.usesTls()) {
     ...
     */
    public final DirContext getInitialDirContext() {
     ...
     *             on an LDAP error
     */
    public final void applyConfig(final ConnectionParameters config)
            throws NamingException {
        this.config = config;
        reloadConfig();
    }
     ...
     */
    public final LdapSearch newSearch() {
