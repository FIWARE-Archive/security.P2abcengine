...
public class FindAttribute {
    public static void main(String... args) throws NamingException,
            LdapException {
        ConnectionParameters cfg = new ConnectionParameters("localhost", 10389,
                10389, 10389, "uid=admin, ou=system", "secret", false);
    ...
    public static void dumpSchema(LdapConnection con, String classDef)
        ...
        for (int i = 0; i < must.size(); i++) {
            ...
            Attributes attrAnswer = schema.getAttributes("AttributeDefinition/"
                    + must.get(i));
