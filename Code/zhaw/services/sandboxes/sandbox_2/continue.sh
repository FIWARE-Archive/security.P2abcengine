...
#  System parameters are generated by the issuance service and need to be communicated
...
#  The credential specification needs to be stored at the user service...
...
#  ... and at the verification service.
...
#  Like mentioned earlier system parameters need to be stored at all services
#  (except GUI services)
...
#  Issuer parameters are also generated by the issuance service based on 
...
#  and they need to be stored at the user...
...
# Issuance Request
#  This starts the multi-round issuance protocol. 
...
#  After UI selection has been done the protocol can continue.
...
#  presentation policy alternatives define what a user
#  needs to satisfy.
...
#  With this we tell the issuer what policy we will fullfill and send
