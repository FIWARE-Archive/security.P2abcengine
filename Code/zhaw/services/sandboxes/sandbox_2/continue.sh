...
curl -X PUT --header 'Content-Type: text/xml' -d @./gen/credSpec.xml 'http://localhost:8888/zhaw-p2abc-webservices/user/storeCredentialSpecification/urn%3Afiware%3Aprivacy%3Acredspec%3Auserdata' > ./out/storeCredentialSpecificationAtUserResponce.xml
...
curl -X PUT --header 'Content-Type: text/xml' -d @./out/systemparameters.xml 'http://localhost:8888/zhaw-p2abc-webservices/user/storeSystemParameters/' > ./out/storeSystemParametersResponceAtUser.xml
...
#curl -X POST --header 'Content-Type: text/xml' -d @./outIssuanceRequest.xml 'http://localhost:8888/zhaw-p2abc-webservices/issuance/initIssuanceProtocol/*magic*' > ./out/issuanceMessageAndBoolean.xml

echo 'IssuanceRequest (by the user)'
curl -X POST --header 'Content-Type: application/xml' -d @issuanceRequest.xml 'http://localhost:8888/zhaw-p2abc-webservices/issuance/issuanceRequest' > ./out/issuanceMessageAndBoolean.xml
...
curl -X POST --header 'Content-Type: text/xml' -d @./out/secondIssuanceMessage.xml 'http://localhost:8888/zhaw-p2abc-webservices/issuance/issuanceProtocolStep/' > ./out/thirdIssuanceMessageAndBoolean.xml
...
curl -X POST --header 'Content-Type: text/xml' -d @./presentationPolicyAlternatives.xml 'http://localhost:8888/zhaw-p2abc-webservices/verification/createPresentationPolicy/' > ./out/presentationPolicyAlternatives.xml
