...
curl -X GET 'http://localhost:8888/zhaw-p2abc-webservices/ldap-issuance-service/attributeInfoCollection/*magic*/person' > ./gen/attrInfoCol.xml

echo 'Generating CredentialSpecification'
curl -X POST --header 'Content-Type: application/xml' -d @./gen/attrInfoCol.xml 'http://localhost:8888/zhaw-p2abc-webservices/ldap-issuance-service/genCredSpec/*magic*/' > ./gen/credSpec.xml
...
curl -X PUT --header 'Content-Type: application/xml' -d @./gen/credSpec.xml 'http://localhost:8888/zhaw-p2abc-webservices/ldap-issuance-service/storeCredentialSpecification/*magic*/urn%3Aabc4trust%3Acredspec%3Aldap%3Aperson'
