...
public interface VerificationStorage {
    ...
    public void addPresentationPolicy(URI uri, PresentationPolicyAlternatives ppa) throws Exception;
    
    public PresentationPolicyAlternatives getPresentationPolicy(URI uri) throws Exception;
