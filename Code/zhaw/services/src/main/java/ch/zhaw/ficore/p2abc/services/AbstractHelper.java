...
//This is a copy of the original ./Code/core-abce/service-helper/src/main/java/eu/abc4trust/ri/servicehelper/AbstractHelper.java
...
public abstract class AbstractHelper {
    ...
    public static StorageFiles verifyFiles(boolean wipe_existing_storage,
        ...
        /*
         * As for trying to make p2abc "production ready" we don't want to have any raw file storage.
         * However, it's hard to locate all the code that uses files etc. and a lot of file handling
         * was done through copy'n'paste and really, really badly engineered. The best thing I can do
         * for now is to set these files to null in the hope that we will receive a NullPointerException
         * if something deep down in the code tries to access a file. 
         */
        StorageFiles storageFiles = new StorageFiles();
        storageFiles.keyStorageFile = null;
        storageFiles.credentialFile = null;
        storageFiles.pseudonymsFile = null;
        storageFiles.tokensFile = null;
        storageFiles.secretStorageFile = null;
        storageFiles.issuerSecretKeyFile = null;
        storageFiles.issuerLogFile = null;
        storageFiles.inspectorSecretKeyFile = null;
        storageFiles.revocationAuthoritySecretStorageFile = null;
        storageFiles.revocationAuthorityStorageFile = null;
        return storageFiles;
    }
