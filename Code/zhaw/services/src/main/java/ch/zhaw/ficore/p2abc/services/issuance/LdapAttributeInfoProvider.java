...
public class LdapAttributeInfoProvider extends AttributeInfoProvider {
	...
	/*
	 * This sets up the dictionaries with recommended mappings for LDAP data
	 * types to p2abc data types and encodings for those mappings. For example
	...
	/**
	 * Returns an AttributeInfoCollection filled with the attributes of an
	 * objectClass in LDAP.
	 * 
	 ...
	 * @param syntax
	 *            LDAP-Syntax
	 * @return mapping (that is, to which XML-Type shall the LDAP-Type be mapped
	 *         to)
	 */
	...
	/**
	 * This function returns the recommended encoding used by the p2abc to
	 * encode XML-Types.
	 * 
	 * @param mapping
